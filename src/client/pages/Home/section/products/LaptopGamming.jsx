...
function LaptopGamming() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        const res = await getProductsInSlug("laptop");
        if (res.ok) {
  ...
  return (
    <div className="bg">
      <div className="banner-laptop">
        <div className="banner-laptop_left">
          <img src="/img/banner11.png" />
        </div>
        <div className="banner-laptop_right">
      ...
      <div className="products">
        ...
        <div className="products_top">
          <h3 className="products_top-title">
            LAPTOP GAMMING CHIẾN GAME KHÔNG GIỚI HẠN | TRẢ GÓP 0%
          </h3>
